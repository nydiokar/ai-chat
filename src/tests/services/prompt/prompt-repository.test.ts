...
import {
  PromptRepository,
  defaultPrompts,
} from "../../../services/prompt/prompt-repository.js";
...
describe("PromptRepository", () => {
  ...
  describe("Input Validation", () => {
    it("should validate prompt type", () => {
      ...
      expect(() => repository.addPrompt(invalidPrompt)).to.throw(
        "Invalid prompt type",
      );
    });
    ...
    it("should validate content is not empty", () => {
      ...
      expect(() => repository.addPrompt(emptyPrompt)).to.throw(
    ...
    it("should validate priority is a positive number", () => {
      ...
      expect(() => repository.addPrompt(invalidPriorityPrompt)).to.throw(
